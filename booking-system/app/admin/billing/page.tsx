...
import { useBillingStore, Invoice, InvoiceLineItem } from '@/lib/billing-store';
import { BookingsStore } from '@/lib/bookings-store';
import { Booking, Clinic } from '@/lib/data';
import { Receipt, Search, Plus, FileText, Printer, Calendar, Clock, User, MapPin } from 'lucide-react';

export default function BillingPage() {
    const { invoices, createInvoice, getInvoices } = useBillingStore();
    ...
    useEffect(() => {
        ...
        // Auto-fill generated by from session
    ...
    const filtered = searchPhone ? getInvoices({ clientPhone: searchPhone }) : invoices;
